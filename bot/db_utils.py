...
quotedb = "quote.db"
init_quote_db = "CREATE TABLE IF NOT EXISTS quotes (quote_text TEXT, tags TEXT, message_id INT, chat_id INT, said_by TEXT, added_by TEXT, said_date TEXT, added_date TEXT, UNIQUE(message_id, chat_id))"
jokedb = "joke.db"
