...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    help_text = ("<u><b>Commands &amp; Instructions:</b></u>\n\n"
                ...
                "<b>❌⚠️IMPORTANT!⚠️❌ Quotes are chat specific!</b>\n\n"
                ""
                "/quote -> \n"
                ...
                "<b>❌⚠️IMPORTANT!⚠️❌ Jokes are global and NOT chat specific!</b>\n\n"
                ""
                "/joke ->\n"
    ...
    try:
        ...
        await update.message.reply_text("Sorry, an error occurred while sending the help message.")                               parse_mode="HTML"
